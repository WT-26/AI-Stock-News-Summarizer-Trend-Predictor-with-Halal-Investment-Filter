				...
				<div className="container mx-auto px-4 py-8 max-w-7xl">
					<div className="flex flex-col gap-6 mb-8">
						<div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
							<div>
								<h1 className="text-4xl font-bold tracking-tight text-balance mb-2 text-[color:var(--text-main)]">
									Financial News AI
								</h1>
							...
							<div className="flex items-center gap-3">
								<HalalFilterToggle
									enabled={halalFilterEnabled}
									onToggle={setHalalFilterEnabled}
								/>
							</div>
						</div>
						...
						<div className="relative max-w-md">
							...
							<Input
								...
								className="pl-10 bg-[color:var(--bg-card)] border-[color:var(--border-light)] text-[color:var(--text-main)]"
							/>
						</div>
						...
						<div className="grid grid-cols-1 md:grid-cols-3 gap-4">
							<Card className="stats-card">
								<CardHeader className="pb-3">
									<CardDescription className="flex items-center gap-2 text-[color:var(--text-muted)]">
										<Sparkles className="h-4 w-4" />
										Total News
									</CardDescription>
									<CardTitle className="text-3xl text-[color:var(--text-main)]">
										{filteredNews.length}
									</CardTitle>
								</CardHeader>
							</Card>
							<Card className="stats-card">
								<CardHeader className="pb-3">
									...
									>
										{Math.round(filteredNews.length * 0.6)}
									</CardTitle>
								</CardHeader>
							</Card>
							<Card className="stats-card">
								<CardHeader className="pb-3">
									...
									>
										{Math.round(filteredNews.length * 0.4)}
									</CardTitle>
								</CardHeader>
							</Card>
						</div>
					...
					<Tabs defaultValue="all" className="w-full">
						<TabsList className="bg-transparent border-b border-[color:var(--border-light)]">
